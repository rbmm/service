...
ULONG CSvcBase::OnSessionChange(ULONG /*dwSessionId*/, ULONG /*dwEventType*/ )
{
	return NOERROR;
}

ULONG CSvcBase::OnDeviceEvent(ULONG /*dwEventType*/, PDEV_BROADCAST_DEVICEINTERFACE /*pdbi*/)
{
	return NOERROR;
}
...
ULONG CSvcBase::PreHandler(ULONG dwControl, ULONG dwEventType, PVOID lpEventData)
{
	...
	case SERVICE_CONTROL_SESSIONCHANGE:
		return OnSessionChange(reinterpret_cast<PWTSSESSION_NOTIFICATION>(lpEventData)->dwSessionId, dwEventType);

	case SERVICE_CONTROL_DEVICEEVENT:
		return OnDeviceEvent(dwEventType, reinterpret_cast<PDEV_BROADCAST_DEVICEINTERFACE>(lpEventData));
